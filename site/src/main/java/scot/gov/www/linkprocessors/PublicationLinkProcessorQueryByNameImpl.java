...
public class PublicationLinkProcessorQueryByNameImpl extends HstLinkProcessorTemplate {

    private static final Logger LOG = LoggerFactory.getLogger(PublicationLinkProcessorQueryByNameImpl.class);
    ...
    static {
        ScheduledReporter reporter = Slf4jReporter.forRegistry(metrics)
                .outputTo(LoggerFactory.getLogger("scot.gov.www.linkprocessors.PublicationLinkProcessorQueryByNameImpl"))
