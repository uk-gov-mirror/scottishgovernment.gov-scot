...
public class PublicationLinkProcessorQueryImpl extends HstLinkProcessorTemplate {

    private static final Logger LOG = LoggerFactory.getLogger(PublicationLinkProcessorQueryImpl.class);
    ...
    static {
        ScheduledReporter reporter = Slf4jReporter.forRegistry(metrics)
                .outputTo(LoggerFactory.getLogger("scot.gov.www.linkprocessors.PublicationLinkProcessorQueryImpl"))
